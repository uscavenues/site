        ...
        <div>
          <div className={styles.card + " card"}>
            ...
            <div className={"cardContent"}>
              ...
              <ul>
                <li>Guide your organization through digital transformation initiatives</li>
                <li>Advise technologies and strategies to enhance customer engagement</li>
          ...
          <div className={styles.card + " card"}>
            ...
            <div className={"cardContent"}>
              <h2>UI/UX Design</h2>
              <ul>
                <li>Advise website design, branding, and overall brand identity</li>
          ...
          <div className={styles.card + " card"}>
            ...
            <div className={"cardContent"}>
              ...
              <ul>
                ...
                <li>Insights into customer behavior, industry trends, and emerging opportunities</li>
                <li>Make informed decisions that resonate with target audience</li>
              </ul>
            </div>
          </div>
          <div className={styles.card + " card"}>
            ...
            <div className={"cardContent"}>
              ...
              <ul>
                <li>Develop comprehensive strategic plans that align with goals</li>
                <li>Analyze market trends, competition, and internal capabilities</li>
                <li>Formulate strategies that drive growth and sustainable success</li>
              </ul>
            </div>
          </div>
        </div>
